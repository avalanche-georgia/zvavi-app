...
export const topoMaxZoom = 17

// The app's base map: OpenTopoMap (contours, peaks, huts — suits avalanche terrain)
const TopoTileLayer = () => (
  <TileLayer
    attribution='&copy; <a href="https://opentopomap.org">OpenTopoMap</a>, <a href="https://www.openstreetmap.org/copyright">OSM</a>'
    maxNativeZoom={topoMaxZoom}
    url="https://{s}.tile.opentopomap.org/{z}/{x}/{y}.png"
  />
)

export default TopoTileLayer
