...
import { aspects, sortedAspects } from '@domain/constants'
...
const AspectSelector = ({ onChange, selectedAspects }: AspectSelectorProps) => {
  ...
  return (
    <div className="inline-flex w-fit items-center gap-1 self-start rounded-sm bg-gray-100 p-1 text-sm dark:bg-white/5">
