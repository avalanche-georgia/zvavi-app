...
// Bottom sheet on mobile, floating right-side panel on desktop. Sheets opened
// from inside another sheet stack on top of it; Esc closes the topmost only.
const Sheet = ({
  children,
  className,
  footer,
  ...
  <Dialog.Root onOpenChange={onOpenChange} open={isOpen}>
    <Dialog.Portal>
      ...
      <Dialog.Popup
        ...
        onKeyDown={onKeyDown}
      >
        <div className="mx-auto mt-2 h-1.25 w-10 shrink-0 rounded-full bg-[#d8d8d4] lg:hidden" />
        <div className="border-rule flex shrink-0 items-center gap-2 border-b pt-2 pr-3 pb-2.5 pl-4 lg:pt-3">
          {header}
        </div>
