...
// Used only if a region has no map center
export const fallbackCenter: [number, number] = [42.1, 43.5]
export const fallbackZoom = 11

export const desktopMediaQuery = '(min-width: 64rem)'
